...
export default () => (
  <div>
    ...
    <p className="text-justify font-light mx-8 my-8"> 
        ...
        Egestas diam in arcu cursus euismod quis viverra. Interdum posuere lorem ipsum dolor sit amet. Viverra nam libero justo laoreet. Malesuada bibendum arcu vitae elementum curabitur. Diam maecenas sed enim ut sem viverra aliquet eget sit. Sit amet commodo nulla facilisi nullam vehicula ipsum a arcu. Gravida arcu ac tortor dignissim convallis aenean et. Sit amet nisl suscipit adipiscing bibendum est. Eget nunc lobortis mattis aliquam faucibus purus in massa tempor. Sem viverra aliquet eget sit amet tellus cras adipiscing. Commodo viverra maecenas accumsan lacus. Nisl tincidunt eget nullam non. Sem integer vitae justo eget magna fermentum. Tempor id eu nisl nunc mi ipsum. Rutrum tellus pellentesque eu tincidunt. 
    </p>
  </div>
)